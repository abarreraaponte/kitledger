import { ApiTokenFactory, SessionFactory, UserFactory } from "../../src/domain/factories/auth_factories.ts";
import { system_permissions, users } from "../../src/services/database/schema.ts";
import { assert } from "@std/assert";
import { createSuperUser, type NewSuperUser } from "../../src/domain/actions/user_actions.ts";
import { db } from "../../src/services/database/db.ts";
import { SYSTEM_ADMIN_PERMISSION } from "../../src/domain/actions/permission_actions.ts";
import { startSession } from "../../src/domain/actions/session_actions.ts";
import { createToken } from "../../src/domain/actions/token_actions.ts";
import { getSessionUserId, getTokenUserId } from "../../src/domain/repositories/user_repository.ts";
import { hashPassword, hashString } from "@core/domain/utils/crypto.ts";
